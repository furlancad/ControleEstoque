<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Unidade.aspx.cs" Inherits="ControleEstoque.Web.Deposito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center" style="padding-bottom: 30px;">
        <span id="lblMsg" class="control-label" style="color: Red;">Ativação e desativação da Unidade.</span>
    </div>
        ...
        <div id="collapse1" runat="server" class="panel panel-default">
            <div class="panel-heading" itemid="collapseOne">
                <h4 class="panel-title">
                    <span class="glyphicon glyphicon-chevron-down"></span>&nbsp;Unidade
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <p>
                        <input id="filterUnidade" type="text" class="filter form-control" placeholder="Refine sua pesquisa" />
                    </p>
                    <div class="table-responsive">
                        <asp:GridView ID="grdUnidade" runat="server" AutoGenerateColumns="False" DataKeyNames="idUnidade" CssClass="grdUnidade table table-bordered table-condensed footable metro-blue toggle-arrow-tiny"
                            OnRowCommand="grdUnidade_RowCommand" OnRowDataBound="grdUnidade_RowDataBound" data-filter="#filterUnidade" data-page-size="10" data-page-navigation=".pagination" data-limit-navigation="5">
                            <Columns>
                                <asp:BoundField HeaderText="Nome" DataField="unidade">
                                ...
                                <asp:TemplateField HeaderText="Ativar/Inativar">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lkAtivarDesativar" runat="server" CommandName="AtivarDesativar" CommandArgument='<%# Eval("idUnidade") %>' CssClass="mylinkbutton glyphicon glyphicon-envelope" ToolTip="Enviar"
